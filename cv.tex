...
show this behaviour graphically using the AWT graphical libraries. (\url{https://github.com/SoftlySplinter/Flocking-Simulator})
...
% CURL auto pull of lecture notes
...
fortress game using the standard GCC libraries. This also included looking into
character encoding (particularly in ASCII and UTF-8).
(\url{https://github.com/SoftlySplinter/c-armok})
...
and a WSGI implementation for testing pytentd on a real web-server.
...
% TODO split this into a better couple of sections.
